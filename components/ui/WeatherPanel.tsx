...
export default function WeatherPanel() {
  ...
  return (
    <section className="w-fit rounded-2xl border border-white/10 bg-white/5 p-6 shadow-lg backdrop-blur-md">
      {/* HEADER */}
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-black/30 text-lg text-zinc-300 transition hover:bg-white/10"
        >
          {expanded ? "−" : "+"}
        </button>
      </div>
